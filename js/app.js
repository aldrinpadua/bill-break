...
function openLedgerModal(kind) {
  ...
  modal(`New ${kindLabel[kind].toLowerCase()}`, `
    ...
    ${CLOUD
      ? `<div class="hint" style="margin-top:14px">👥 After you create this, open the <b>Members</b> tab to add people by email — existing Bill Break users join instantly, and anyone else gets an invite link.</div>`
